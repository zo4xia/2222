...
// @legacy L3-S01 ✅ 已治理 · Key 移到 .env
// 默认 Key 改为从 process.env.FISH_AUDIO_API_KEYS 读取（逗号分隔）
// 用户预设账号保留在 .env 文件中（不进 git）
const DEFAULT_API_KEYS = []  // 源码中不再硬编码 Key
...
export function getApiKeys() {
  ...
  // 只用 env 配置的 Key，源码中不再有硬编码 fallback
  return envKeys
}
