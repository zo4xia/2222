...
.pulse-card {
  ...
  border-radius: var(--qh-radius-dialog);
  ...
  position: relative;
  overflow: hidden;
  box-shadow: var(--qh-shadow-raise);
...
.pulse-beacon-outer {
  ...
  inset: -6px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(29, 78, 216, 0.14) 0%, rgba(29, 78, 216, 0.04) 65%, transparent 100%);
